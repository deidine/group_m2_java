                    ...
                    <body>
                        ...
                        <section id="content">
                            ...
                            <main>
                                ...
                                <button type="button">
                                    <a href="${pageContext.request.contextPath}/crudCompte?action=create&compteId=1">
                                        crer un compte
                                    </a>
                                </button>
                                                ...
                                                <c:forEach var="compte" items="${comptes}">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="${pageContext.request.contextPath}/crudCompte?action=edit&compteId=${compte.id}"
                                                                title="Modifier">
                                                                <i class='bx bx-edit' style='color: #3498db;'></i>
                                                            </a>

                                                            <a href="${pageContext.request.contextPath}/crudCompte?action=delete&compteId=${compte.id}"
                                                                title="Suprimer">
