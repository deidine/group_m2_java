...
<head>
  ...
  href="https://unpkg.com/boxicons@latest/css/boxicons.min.css">
    ...
    display: none;
    position: fixed;
    top: 50%; /* Ajustez cette valeur en fonction de votre mise en page spécifique */
    left: 50%; /* Ajustez cette valeur en fonction de votre mise en page spécifique */
...
<section id="sidebar">
		...
		<ul class="side-menu top">
			<li class="active">
				<a href="${pageContext.request.contextPath}/clientCrud?action=list">
					<i class='bx bxs-user-circle'></i>
					<span class="text">Client</span>
				</a>
			</li>
			<li>
				<a href="${pageContext.request.contextPath}/crudCompte?action=list">
...
<!-- CONTENT -->
   ...
   <input type="checkbox" id="switch-mode" hidden>
			...
			<a href="#" class="profile">
				<img src="images/icons/compte.png">
			</a>
   </nav>
 <main>
...
<a href="${pageContext.request.contextPath}/clientCrud?action=edit&clientId=${client.id}" title = "Modifier" >
  <i class='bx bx-edit' style='color: #3498db;'></i>
</a>

<a href="${pageContext.request.contextPath}/clientCrud?action=delete&clientId=${client.id}" title = "Suprimer">
  <i class='bx bx-trash' style='color: #e74c3c;'></i>
</a>

<a href="${pageContext.request.contextPath}/clientCrud?action=details&clientId=${client.id}" title = "Associer compte">
