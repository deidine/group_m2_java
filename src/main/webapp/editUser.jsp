...
<form class="user-form-container" action="${pageContext.request.contextPath}/clientCrud?action=update" method="post">
    ...
    <input type="text" placeholder="Email" name="email" value="${client.email}" required>
    <input type="text" placeholder="Téléphone" name="phone" value="${client.phone}" required>
    <input type="password" placeholder="Mot de passe" name="password" value="${client.password}" required>
