...
//		response.sendRedirect(request.getContextPath() + "/carte.jsp");
	...
	private void validatePin(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		// TODO Auto-generated method stub
		...
		if (crt.verfiPin(pin)) {
			...
			new MachineServelet().doPost(request, response);
...
//String sldleft=String.p
				...
				try {
					...
					if (!carte.equals(null)) {
						...
						TransactionServelet transactionServelet = new TransactionServelet();
